    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-14">
        <ProjectsCard
          ...
          des="SHIPEASE is a comprehensive Bilty management system designed to streamline logistics operations, built with React and Material-UI for dynamic interfaces, Node.js and Express.js for server-side logic, PostgreSQL for data management, and Postman for API testing. It uses authentication for secure access."
          src={projectOne}
          Icon={<BsGithub />}
          Icon1={<FaFileAlt />}
        ...
        <ProjectsCard
          ...
          des="SHIPEASE Mobile Application, built with React Native, Node.js, and Postman, enables users to book Bilty through tenant, vehicle, or attribute searches, connecting drivers and users for efficient cargo management. Additionally, it includes comprehensive API testing for robust performance and reliability."
          src={projectTwo}
          Icon={<BsGithub />}
          Icon1={<FaFileAlt />}
        ...
        <ProjectsCard
          ...
          des="The Lost & Found Platform helps recover lost items and supports charity by managing lost and found items efficiently. Unclaimed items are donated to promote goodwill. It uses MVC architecture for maintainability and is built with HTML, CSS, and JavaScript to provide a dynamic, engaging user experience."
          src={projectThree}
          Icon={<BsGithub />}
          Icon1={<FaFileAlt />}
        ...
        <ProjectsCard
          ...
          des="This desktop application, developed in C#, streamlines inventory management with a Super Admin Panel for oversight, user management, and item assignment. The User Admin component manages items, categories, and alerts. It also supports requirements gathering and Email/SMS notifications."
          src={projectFive}
          Icon={<BsGithub />}
          Icon1={<FaFileAlt />}
